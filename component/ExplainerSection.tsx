...
export default function ExplainerSection() {
  return (
    <div className="w-full max-w-6xl mt-16 p-8 bg-gray-100 rounded-lg space-y-8">
      <h2 className="text-3xl font-bold text-center mb-8">Хэрхэн ажилладаг</h2>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-center space-x-4">
          ...
          <h3 className="text-2xl font-semibold">Өөрийн цэвэрхэн гарсан зураг оруулна</h3>
        </div>
        <img
          src={example.src}
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-center space-x-4">
          ...
          <h3 className="text-2xl font-semibold">Хиймэл оюун ухаан ажиллаж эхэлнэ</h3>
        </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-center space-x-4">
          ...
          <h3 className="text-2xl font-semibold">Таны зураг бэлэн болно</h3>
        </div>
        <p className="text-sm text-gray-600 text-center">
        </p>
        <img
